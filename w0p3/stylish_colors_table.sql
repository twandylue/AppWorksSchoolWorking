...
LOCK TABLES `colors_table` WRITE;
/*!40000 ALTER TABLE `colors_table` DISABLE KEYS */;
INSERT INTO `colors_table` VALUES ('1','1'),('a','a');
/*!40000 ALTER TABLE `colors_table` ENABLE KEYS */;
UNLOCK TABLES;
